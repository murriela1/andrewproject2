...
app.get('/', function(req, res) {
  ...
  // TODO better way of populating answers 
      for (var i = 0; i < questionsArr.length; i++) {
        questionsArr[i].answers = [];
        for (var j = 0; j < answer.length; j++) {
          if (answer[j].QuestionId == questionsArr[i].id) {
            questionsArr[i].answers.push(answer[j]);
          }
        }
      }
...
app.post('/questions/:questionId/answer/:answerId', function(req, res) {
  console.log("Answered question " + req.params.questionId + " with answer: " + req.params.answerId);
